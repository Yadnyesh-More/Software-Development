...
################################################################################
## Form generated from reading UI file 'interfacezgFgxa.ui'
##
...
"")
        ...
        self.label_3.setPixmap(QPixmap(u":/icons/briefcase.svg"))
...
"}")
        ...
        self.page.setGeometry(QRect(0, 0, 200, 266))
        ...
        icon = QIcon()
        icon.addFile(u":/icons/alert-triangle.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/bar-chart-2.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/printer.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/phone-incoming.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/external-link.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"")
        ...
        icon7 = QIcon()
        icon7.addFile(u":/icons/align-left.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border-bottom : 3px solid rgb(230,5,64)")
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/search.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/arrow-down-left.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/maximize-2.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"border-radius:30px;")
        self.label_5.setPixmap(QPixmap(u":/icons/briefcase.svg"))
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/box.svg", QSize(), QIcon.Normal, QIcon.Off)
