...
################################################################################
## Form generated from reading UI file 'signuppgbShbBy.ui'
##
...
"")
        ...
        self.login_heading.setGeometry(QRect(93, 23, 151, 61))
        font = QFont()
...
"}")
        ...
        self.password_heading.setStyleSheet(u"color:rgb(18, 140, 126);")
...
"}")
        ...
        self.pushButton_3.setGeometry(QRect(239, 203, 21, 16))
        self.pushButton_3.setStyleSheet(u"background:none; border:none;")
        icon = QIcon()
        icon.addFile(u"PropImages/eye.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pushButton_3.setIcon(icon)
        self.pushButton_3.setCheckable(True)
        self.pushButton_3.setAutoRepeat(True)
        self.pushButton_4 = QPushButton(self.widget_2)
        self.pushButton_4.setObjectName(u"pushButton_4")
        self.pushButton_4.setGeometry(QRect(238, 275, 21, 16))
        self.pushButton_4.setStyleSheet(u"background:none; border:none;")
        icon1 = QIcon()
        icon1.addFile(r"C:\MemoFull\Codes\PySide6\FinalDashBrd\images\eye.png", QSize(), QIcon.Normal, QIcon.On)
        icon1.addFile(r"C:\MemoFull\Codes\PySide6\FinalDashBrd\images\hidden.png", QSize(), QIcon.Normal, QIcon.Off)
        icon1.addFile(r"C:\MemoFull\Codes\PySide6\FinalDashBrd\images\hidden.png", QSize(), QIcon.Disabled, QIcon.Off)
