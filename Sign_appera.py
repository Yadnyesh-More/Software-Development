...
from MiddleManDashboard import Ui_MainWindow as Dashboardpage
...
class MainWindow(QWidget):
    ...
    def __init__(self):
        ...
        self.login_page_widget.ui.pushButton_3.clicked.connect(self.show_password)

        self.signup_page_widget.ui.pushButton_4.clicked.connect(self.show_password_1)

        self.dash_main = Dashboardpage()
        layout = QVBoxLayout()
    ...
    def show_password(self):
        if self.login_page_widget.ui.pushButton_3.isChecked():
            self.login_page_widget.ui.password_entry.setEchoMode(QLineEdit.Normal)
        else:
            self.login_page_widget.ui.password_entry.setEchoMode(QLineEdit.Password)

    def show_password_1(self):
        if self.signup_page_widget.ui.pushButton_4.isChecked():
            self.signup_page_widget.ui.confirm_password_entry.setEchoMode(QLineEdit.Normal)
        else:
            self.signup_page_widget.ui.confirm_password_entry.setEchoMode(QLineEdit.Password)
        ...
        if self.login_email == "" or self.login_pass == "":
            ...
            if(re.fullmatch(pattern, self.login_email)):
                ...
                if self.result1 is not None:
                    self.check_email = self.result1[0]
                    self.check_pass = self.result1[1]
                    if self.login_email == self.check_email:
                        if self.login_pass == self.check_pass:
                            QMessageBox.information(None,"Result","Login Succesful !!! ")
                            print("login")
...
middleman3701@gmail.com""")
                            ...
                            self.curr.execute("create table if not exists scratch_earn (email_id varchar(30),card_scratch varchar(50),Remaining_MMcash int)")
                            q = "insert into upload_image(email_id) values (%s)"
                            self.curr.execute(q,self.login_email)
                            q = "insert into refer_earn(email_id) values (%s)"
                            self.curr.execute(q,self.login_email)
                            q = "insert into scratch_earn(email_id) values (%s)"
                            self.curr.execute(q,self.login_email)
                            print(self.login_email)
                            self.a.commit()
                            print("database")
                            self.window_closer()
                            self.dash = subprocess.run(['python', 'MiddleManDashboard.py'])                    
                        else:
                            QMessageBox.warning(None,"Error","Entered Password Is Incorrect !!! ")
                ...
                QMessageBox.warning(None,"Error","Enter Email in Right Format !! ")
...
import smtplib
from email.message import EmailMessage
from NeDash import Ui_MainWindow as Dashboardpage

# At login page hide button will be pushbuttn_3
# At Sign_up page hide button will be pushbuttn_4


required_files = [
    r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\Useless\forget_pg.py",
    r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\Useless\login_pg.py",
    r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\reset_pg.py",
    r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\Useless\signup_pg.py",
]


sys.path.insert(1, r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\Useless")
sys.path.insert(1, r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\Useless")
sys.path.insert(1, r"C:\Users\Asus3\OneDrive\python\software development\Software-Development-main\Software-Development-main\Yadnyesh\FinalDashBrd\Useless")
...
8097667158""")
    ...
    #        window.close()
    #        #self.dash = subprocess.run(['python', 'DashPy.py'])
    #        # self.dash_main.feedback_submit.clicked.connect(self.dash_main.feed_submit)
    #        # self.dash_main.feedback_submit.clicked.connect(self.tim)
#
    #    else:
    #        print("No")
    #        window.close()
...
if __name__ == "__main__":
    ...
    sys.exit(app.exec())
>>>>>>> 507a1d0f380e25db1ea2105c60f942947566dda7
